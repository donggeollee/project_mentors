...
//state: ���ø����̼��� ������ ���� ��ū
	private final static String CLIENT_ID = "2IvG7tvfa37LejwhE6xX";
	private final static String CLIENT_SECRET = "dFQbpK69Hi";
	private final static String REDIRECT_URI = "http://localhost:8080/mentors/mentee/callback";
